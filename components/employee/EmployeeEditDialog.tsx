...
const EmployeeEditDialog: React.FC<EmployeeEditDialogProps> = ({
  ...
  const { fields: workingHoursFields, update: updateWorkingHours } = useFieldArray({
    control,
    name: 'workingHours',
  });
  ...
  const updateShift = (dayIndex: number, shiftIndex: number, field: string, value: string) => {
    const currentDay = workingHoursFields[dayIndex];
    ...
    <Box height="60vh" overflowY="auto" pr={2}>
      <Stack gap={6} align="stretch">
        {workingHoursFields.map((day, dayIndex) => (
          <Box key={day.dayOfWeek} p={4} borderWidth={1} borderRadius="md" bg="gray.50">
             ...
             >
               <Stack gap={3} align="stretch">
                 {day.shifts.map((shift, shiftIndex) => (
                   <Box key={shiftIndex} p={3} bg="white" borderRadius="md" borderWidth={1}>
                     ...
                     <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={3}>
                       <GridItem>
                         <Box>
                           <Text mb={1} fontSize="sm" fontWeight="medium">Start Time</Text>
                           <input
                             type="time"
                       ...
                       <GridItem>
                         <Box>
                           <Text mb={1} fontSize="sm" fontWeight="medium">End Time</Text>
                           <input
                             type="time"
                             value={shift.endTime}
                       ...
                       <GridItem>
                         <Box>
                           ...
                           <input
                             ...
                             onChange={(e) => updateShift(dayIndex, shiftIndex, 'description', e.target.value)}
